...
./GetAppIds.sh $RESULTS_DIR $PERFDATA_OUTPUTDIR $TIMELINE_SERVER

./GetTezDags.sh $RESULTS_DIR $PERFDATA_OUTPUTDIR $TIMELINE_SERVER

./GetTezDagIds.sh $RESULTS_DIR $PERFDATA_OUTPUTDIR $TIMELINE_SERVER

./GetATSDAG.sh $PERFDATA_OUTPUTDIR

./getStoreLatency.sh $QUERY_TIMES_FILE $PERFDATA_OUTPUTDIR
...
echo "zipped Perfdata to $OUTPUT_DIR/PerfData_$RUN_ID.zip"
